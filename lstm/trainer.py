...
from .utils import center_scene, random_rotation, add_noise, drop_distant, filter_opposite_x_velocity
...
class Trainer(object):
    ...
    def loop(self, train_scenes, val_scenes, train_goals, val_goals, out, epochs=25, start_epoch=0):
    ...
    def train_batch(self, batch_scene, batch_split):
        ...
        batch_scene_goal : Tensor [num_tracks_cars, 4]
        ...
        loss = self.criterion(train_pred[:, :, 0:2], train_truth[:, :, 0:2]) * self.batch_size
    ...
    def val_batch(self, batch_scene, batch_split):
        ...
        with torch.no_grad():
            ...
            loss = self.criterion(val_pred[:, :, 0:2], val_truth[:, :, 0:2]) * self.batch_size
...
def main(epochs=25):
    ...
    parser.add_argument('--type', default='physical',
                        choices=('physical', 'vanilla', 'occupancy', 'directional', 'social', 'hiddenstatemlp',
